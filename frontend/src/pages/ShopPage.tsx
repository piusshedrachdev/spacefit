...
/**
 * Shop — the catalogue page (ported from the legacy index.html + js/index.js):
 * hero/search, catalogue toolbar, filter sidebar, product grid, empty state,
 * and the consultation banner (rendered only for signed-in customers via
 * <IfCan>, per src/lib/permissions.ts — the legacy markup kept it permanently
 * hidden). Served at `/shop` (with `/products` redirecting here); the marketing
 * homepage lives in src/pages/HomePage.tsx at `/`.
 */
